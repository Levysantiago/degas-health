...
public class TesteAceitacaoFinal {
	...
	public void testCadastros() {
		...
		/*-----------------Mais testes após nova persistência-----------------------------*/
		...
		assertEquals("Enfermeiro inserido!", res);
			...
			res = facade.novoAuxiliar("Pablo Bardo da Sofrência Boêmio","M","289673","Brasil","12/10/1984","31/11/2013","05/01/2011");
			assertEquals("ERRO! Data Inválida!", res);

			res = facade.novoAuxiliar("Quincas Borba","M","289673","Brasil","12/10/1983","31/11/2012","05/01/2011");
			assertEquals("ERRO! Data Inválida!", res);
...
/*-------------------------Procedimentos --------------------------------------------*/
			...
			// Procdimento: Codigo, Descrição, Custo
			...
			assertEquals("404482%Redução de Fratura%R$2000", res);
...
//-------------------------------------agora fazendo associações: procedimentos soncomem materiais e usam equipamentos-----
			...
			res = Facade.materialProcedimento("763236","5927"); // Ponte de Safena consome Stinter cardíaco
			assertEquals("Material Incluido com sucesso no procedimento", res);
			...
			res = Facade.materialProcedimento("377523","2415"); // Transplante Coração consome Fio de Sutura
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","3314"); // Transplante Coração consome Gaze
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","9622"); // Transplante Coração consome Esparadrapo
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","5796"); // Transplante Coração consome Parafuso de Platina
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","4404"); // Transplante Coração consome Placa de Platina
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","8996"); // Transplante Coração consome Antisseptico
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("377523","1110"); // Transplante Coração consome Anestesia Geral
			assertEquals("Material Incluido com sucesso no procedimento", res);

			res = Facade.equipamentoProcedimento("377523","912"); // Transplante Coração necessita do apoio de Mesa de Cirurgia
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("377523","188"); // Transplante Coração necessita do apoio de Cadeira
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("377523","685"); // Transplante Coração necessita do apoio de Raio X
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("377523","206"); // Transplante Coração necessita do apoio de Ultrassom
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("377523","845"); // Transplante Coração necessita do apoio de Tomógrafo
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);


			res = Facade.materialProcedimento("404482","1881"); // Redução de Fratura consome Gesso
			assertEquals("Material Incluido com sucesso no procedimento", res);

			res = Facade.equipamentoProcedimento("404482","885"); // Redução de Fratura necessita do apoio de Maca
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("404482","188"); // Redução de Fratura necessita do apoio de Cadeira
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("404482","358"); // Redução de Fratura necessita do apoio de Mesa de Trabalho
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);


			res = Facade.equipamentoProcedimento("894275","912"); // Amputação de Membro necessita do apoio de Mesa de Cirurgia
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("894275","188"); // Amputação de Membro necessita do apoio de Cadeira
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("894275","358"); // Amputação de Membro necessita do apoio de Mesa de Trabalho
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);
			res = Facade.equipamentoProcedimento("894275","685"); // Amputação de Membro necessita do apoio de Raio X
			assertEquals("Equipamento Incluido com sucesso no procedimento", res);

			res = Facade.materialProcedimento("894275","2415"); // Amputação de Membro consome Fio de Sutura
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("894275","3314"); // Amputação de Membro consome Gaze
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("894275","9622"); // Amputação de Membro consome Esparadrapo
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("894275","8996"); // Amputação de Membro consome Antisseptico
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("894275","1110"); // Amputação de Membro consome Anestesia Geral
			assertEquals("Material Incluido com sucesso no procedimento", res);
//--------------------------Checando a persistência ----------------------------------
...
//-------------------------------------prosseguindo os testes---------------------------------------------------
			...
			//Nebulização
			res = Facade.materialProcedimento("200752","7278"); // Nebulização consome Broncodilatador
			assertEquals("Material Incluido com sucesso no procedimento", res);
			...
			assertEquals("Material Incluido com sucesso no procedimento", res);
			res = Facade.materialProcedimento("886244","5927"); // Cateterismo consome Stinter cardíaco
			assertEquals("Material Incluido com sucesso no procedimento", res);
			
//---------------------------Mais testes de persistência também
